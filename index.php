...
<div id="announcement-modal" class="modal fixed inset-0 z-50 items-center justify-center bg-black bg-opacity-50">
    <div class="bg-white rounded-xl shadow-2xl p-6 w-11/12 md:w-1/3">
        <div class="flex justify-between items-center border-b pb-3 mb-4">
            <h3 class="text-xl font-bold text-red-600">🚨 ประกาศด่วน!</h3>
    ...
    <div class="max-w-7xl mx-auto px-4">
        <div class="flex justify-between h-16">
            ...
            <div class="flex items-center">
                <span class="text-2xl font-extrabold text-[#388E3C]">E-Dashboard</span>
            </div>

            <div class="flex items-center space-x-4">

                <!-- ปุ่มประกาศ -->
                <button onclick="openModal()" class="relative text-red-500">
                    🔔
                    <span class="absolute top-0 right-0 w-3 h-3 bg-red-600 rounded-full animate-pulse"></span>
                </button>

                <!-- User -->
                <span class="px-4 py-2 bg-gray-100 rounded-full text-sm">
                    <span class="font-bold text-[#388E3C]">User:</span>
...
<main class="max-w-7xl mx-auto py-6">
    ...
    <div class="grid grid-cols-2 md:grid-cols-5 gap-6">
        ...
        <!-- Card 1 -->
        <a class="bg-white p-6 rounded-xl shadow hover:shadow-lg border-t-4 border-blue-500 flex flex-col items-center">
            ...
            <span class="font-bold text-gray-700">ตรวจสอบสต็อก</span>
        </a>

        <!-- Card 2 -->
        <a class="bg-white p-6 rounded-xl shadow hover:shadow-lg border-t-4 border-red-500 flex flex-col items-center">
            <svg class="w-8 h-8 text-red-500 mb-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                      d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 11-4 0 2 2 0 014 0z"></path>
            </svg>
            <span class="font-bold text-gray-700">ยอดขายรายวัน</span>
        </a>

        <!-- Cards 3–5 (Scroll Area) -->
